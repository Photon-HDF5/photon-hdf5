# -*- coding: utf-8 -*-
#
# Photon-HDF5 documentation build configuration file, created by
...
project = u'Photon-HDF5'
copyright = u'2014, Antonino Ingargiola, Xavier Michalet, Ted Laurence'
...
htmlhelp_basename = 'Photon-HDF5doc'
